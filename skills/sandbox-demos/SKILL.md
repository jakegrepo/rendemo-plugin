...
- **You can drive a browser** the author is signed into: per page — navigate, **let it finish
  rendering**, then evaluate the snippet with that page's index. The page uploads itself and
